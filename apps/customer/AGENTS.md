...
- ALWAYS: Use Capacitor plugins for native features (camera, storage, notifications)
- NEVER: Use browser-only APIs without Capacitor fallback
- ALWAYS: Test on both web and mobile targets
