# Inventory Service - AI Agent Ruleset
...
- Inventory tracks equipment, uniforms, gear per tenant
- ALWAYS: Stock mutations go through domain use cases — never direct DB writes
- ALWAYS: Entities validate stock invariants (e.g. stock cannot go negative)
