...
name: vite
description: >
  Vite 8 (Rolldown-powered) build tool configuration, plugin API, SSR, and migration guide.
  Trigger: When working with vite.config.ts, Vite plugins, building libraries, or SSR apps with Vite.
license: MIT
metadata:
  author: antfu
  version: '2026.1.31'
  ...
  auto_invoke:
    - 'Configuring vite.config.ts or Vite plugins'
    - 'Migrating to Vite 8 or Rolldown bundler'
    - 'Building libraries or SSR apps with Vite'
