...
name: playwright
description: >
  Comprehensive Playwright E2E testing: Page Object Model, CI/CD, accessibility, performance, mocking, and advanced patterns.
  Trigger: When writing Playwright E2E tests, fixing flaky tests, configuring CI, or implementing POM.
license: MIT
metadata:
  author: currents-dev
  version: '1.1'
  ...
  auto_invoke:
    - 'Writing Playwright E2E tests or Page Object Model'
    - 'Fixing flaky Playwright tests or configuring Playwright CI/CD'
    - 'Mocking APIs, handling auth flows, or testing accessibility with Playwright'
