...
description: >
  ...
  Trigger: When asked to improve accessibility, a11y audit, WCAG compliance, screen reader support, keyboard navigation, or making components accessible.
license: MIT
metadata:
  ...
  auto_invoke:
    - 'Implementing accessible components or keyboard navigation'
    - 'Auditing UI for WCAG compliance'
    - 'Adding ARIA attributes or screen reader support'
