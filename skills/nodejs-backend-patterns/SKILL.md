...
description: >
  Build production-ready Node.js backend services with Fastify, middleware patterns, error handling, authentication, and API design.
  Trigger: When creating Node.js servers, REST APIs, or microservices beyond NestJS scope.
license: MIT
metadata:
  author: wshobson
  version: '1.0'
  scope: [api-gateway, auth-service, club-service, inventory-service, booking-service, finance-service]
  auto_invoke:
    - 'Building Node.js REST APIs or middleware pipelines outside NestJS'
    - 'Implementing authentication or error handling at the Node.js level'
