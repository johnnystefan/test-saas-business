...
description: >
  ...
  Trigger: When asked to improve SEO, optimize for search, fix meta tags, add structured data, or sitemap optimization.
license: MIT
metadata:
  ...
  auto_invoke:
    - 'Improving SEO or adding meta tags'
    - 'Adding structured data or JSON-LD'
    - 'Optimizing sitemap or robots.txt'
