...
description: >
  ...
  Trigger: When writing, reviewing, or refactoring NestJS code — modules, DI, security, performance, testing.
license: MIT
metadata:
  author: Kadajett
  version: '1.1.0'
  ...
  auto_invoke:
    - 'Reviewing NestJS architecture, DI patterns, or security'
    - 'Refactoring NestJS modules or services for production readiness'
    - 'Implementing NestJS microservices or database optimization'
