...
metadata:
  scope: [root, admin, customer, api-gateway, admin-gateway, auth-service, club-service, inventory-service, booking-service, finance-service, libs]
  auto_invoke: 'Workspace package import errors or cannot find module (@org/*)'
---
