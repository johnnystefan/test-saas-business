...
description: >
  Prisma Client API: model queries, filters, operators, CRUD, relations, transactions, and client methods.
  Trigger: When writing Prisma queries, performing CRUD operations, filtering data, using transactions, or configuring Prisma Client.
license: MIT
metadata:
  author: prisma
  version: '7.6.0'
  scope: [auth-service, club-service, inventory-service, booking-service, finance-service]
  auto_invoke:
    - 'Writing Prisma queries, findMany, create, update, delete, or $transaction'
    - 'Using Prisma Client relations, filters, or pagination'
