...
name: prisma-cli
description: >
  Prisma CLI commands: init, generate, migrate, db push/pull, studio, and debug.
  Trigger: When running Prisma CLI commands, generating client, running migrations, or managing database state.
license: MIT
metadata:
  author: prisma
  version: '7.6.0'
  ...
  auto_invoke:
    - 'Running prisma migrate, prisma generate, or prisma db commands'
    - 'Setting up Prisma CLI or using prisma studio'
