...
description: >
  Configure Prisma with PostgreSQL, MySQL, SQLite, MongoDB, and other providers.
  Trigger: When setting up a new Prisma project, changing database providers, or troubleshooting connection issues.
license: MIT
metadata:
  author: prisma
  version: '7.6.0'
  ...
  auto_invoke:
    - 'Setting up Prisma with a new database provider or connection string'
    - 'Troubleshooting Prisma database connection or provider configuration'
