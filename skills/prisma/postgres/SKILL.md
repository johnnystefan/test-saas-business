...
description: >
  Prisma Postgres: setup via Console, create-db CLI, Management API, and SDK for provisioning and integration.
  Trigger: When creating Prisma Postgres databases, provisioning with create-db, or using the Management API.
license: MIT
metadata:
  author: prisma
  version: '7.6.0'
  ...
  auto_invoke:
    - 'Setting up or provisioning Prisma Postgres databases'
    - 'Using Prisma Console, create-db CLI, or Management API SDK'
